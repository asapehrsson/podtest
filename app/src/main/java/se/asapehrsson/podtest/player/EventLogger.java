...
/* package */ final class EventLogger implements Player.EventListener, AudioRendererEventListener,
    ...
    public EventLogger(MappingTrackSelector trackSelector, SimpleExoPlayer player) {
    ...
    public void onTimelineChanged(Timeline timeline, Object manifest) {
        ...
        Log.d(TAG, "BufferedPercentage = " + player.getBufferedPercentage() + " BufferedPosition=" + player.getBufferedPosition()
                + " Duration=" + duration
                + " CurrentPosition=" + currentPosition
                + " Diff=" + (duration - currentPosition));
